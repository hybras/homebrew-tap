...
class AsciidoctorMathematicalDeps < Formula
  ...
  # fonts
  # depends_on "homebrew/homebrew-cask-fonts/font-jsmath-cmex10"
  # depends_on "homebrew/homebrew-cask-fonts/font-jsmath-cmmi10"
  # depends_on "homebrew/homebrew-cask-fonts/font-jsmath-cmr10"
  # depends_on "homebrew/homebrew-cask-fonts/font-jsmath-cmsy10"
  # depends_on "homebrew/homebrew-cask-fonts/font-jsmath-cmex10"
